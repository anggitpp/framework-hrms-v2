...
class AttendanceDurationRecapExport implements FromCollection, WithCustomStartCell, WithColumnWidths, WithEvents
{
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->mergeCells(numToAlpha($i + 2)."5:".numToAlpha($i + 2)."6");
                $sheet->setCellValue(numToAlpha($i + 2)."5", 'TOTAL');
