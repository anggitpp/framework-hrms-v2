        ...
        <div class="card-body py-4">
            <div class="table-responsive">
                <table id="datatables" class="table table-rounded table-row-bordered border gy-5 gs-7">
                    <thead>
                        <tr class="text-start text-muted bg-gray-100 fw-bold fs-7 text-uppercase gs-0 border-bottom border-gray-200">
                            ...
                            <th class="min-w-150px">Nama Aset</th>
                            <th class="min-w-150px">Nomor Aset</th>
                ...
                @php
                    ...
                    $datas = array("employee_number", "employee_name", "name", "number", "type_id", "start_date\ttext-center", "end_date\ttext-center", "filename\ttext-center", "status\ttext-center", "action\ttrue\tfalse");
                @endphp
