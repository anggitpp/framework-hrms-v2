            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-toolbar">
                    <div class="d-flex justify-content-end">
                        ...
                        @can('add '.$menu_path)
                            <x-views.add-button route="{{ route(str_replace('/', '.', $menu_path).'.create') }}" text="Tambah Data Pendidikan" />
                        @endcan
                    </div>
                </div>
            </div>
        ...
        <div class="card-body py-4">
            <div class="table-responsive">
                <table id="datatables" class="table table-rounded table-row-bordered border gy-5 gs-7">
                    <thead>
                        <tr class="text-start text-muted bg-gray-100 fw-bold fs-7 text-uppercase gs-0 border-bottom border-gray-200">
                            ...
                            <th class="min-w-150px">Tingkatan</th>
                            <th class="min-w-200px">Nama Institusi</th>
                ...
                @php
                    ...
                    $datas = array("employee_number", "employee_name", "level_id", "name", "major", "start_year", "end_year", "action\ttrue\tfalse");
                @endphp
